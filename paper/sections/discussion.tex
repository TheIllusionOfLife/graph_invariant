...
signals.
(iv)~Although we report mean $\pm$ std across 10 seeds, the observed
differences between Harmony and DistMult-alone are small relative to
cross-seed variance (e.g.\ Wikidata Materials Hits@10: paired $t$-test
$p = 0.45$); larger-scale experiments with more generations or larger KGs may
