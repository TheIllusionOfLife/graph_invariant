...
Specifically, LLMs act as a structured mathematical prior: they compose known constructs (harmonic means, Moore bounds, min-of-bounds) rather than performing blind operator search, enabling candidates that are plausible starting points for proof.
