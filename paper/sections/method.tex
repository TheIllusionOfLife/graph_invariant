...
Jensen--Shannon distance, defined as the square root of the Jensen--Shannon
divergence (base~2 logarithm), yielding a proper metric bounded in $[0,1]$.  When $T \leq 1$ (a
