...
\begin{figure}[t]
  ...
  \caption{Out-of-distribution generalization across three graph categories.
    ...
    topologies (special: $\rho = 0.465$, $n=16$ graphs).}
  \label{fig:ood}
\end{figure}
...
candidates. A controlled 3-seed ablation confirms that SC raises mean
validation $\rho$ by $+0.045$ with $3{\times}$ lower cross-seed variance
