...
Our system discovers interpretable compositions of graph invariants/features through an evolutionary loop that
...
\begin{equation}
  ...
  \label{eq:score}
\end{equation}
where $\alpha = 0.5$, $\beta = 0.2$, $\gamma = 0.3$ by default.
...
empirical search for candidate mathematical inequalities relating graph
properties; universal validity requires additional proof.
