...
Recent work explores LLMs as reasoners over structured knowledge
\citep{ji2021kgsurvey}, using chain-of-thought prompting or retrieval-augmented
generation.  Our approach differs: the LLM is a \emph{proposer} that generates
