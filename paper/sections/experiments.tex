...
effective proportions of approximately 72/9/9/10 over all edges).  This provides
...
All experiments use a single seed ($s = 42$) for dataset splitting, model
initialisation, and edge masking; multi-seed evaluation is noted as a limitation
