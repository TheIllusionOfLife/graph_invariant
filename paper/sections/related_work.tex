...
justification.  LLM-based scorers such as KG-BERT
...
landscape.  More recently, \citet{alphaproof2024} use LLM + RL agents to
discover formal mathematical proofs verified by Lean.
