...
in the materials domain ($0.31$ vs.\ $0.29$), while the frequency heuristic
proves a strong competitor across all domains.  The high variance across seeds
(std $\approx 0.14$--$0.23$) reflects the stochastic nature of LLM-guided
proposal generation; aggregating across 10 seeds provides a more reliable
comparison than single-seed evaluation.  In materials, Harmony (ours) achieves
the best Hits@10 while maintaining lower MRR variance ($0.05$ vs.\ $0.09$),
suggesting more consistent link prediction quality.
