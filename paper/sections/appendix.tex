...
The following prompt was used to score each proposal on four dimensions (1--5
scale) using Gemini~2.5~Pro as an automated evaluator.  The dimensions and
scale definitions are included in-prompt to ensure consistent interpretation.

\begin{quote}\small\ttfamily
You are a scientific knowledge evaluator assessing theory proposals for
knowledge graphs. Evaluate the following proposal from the \{domain\} domain.

PROPOSAL:\\
\quad Claim: \{claim\}\\
\quad Justification: \{justification\}\\
\quad Falsification condition: \{falsification\_condition\}\\
\quad KG mutation: \{edge\_type\}(\{source\} $\to$ \{target\})\\[4pt]

RUBRIC:\\
Plausibility (1--5): Is the claim scientifically plausible?\\
\quad 1=contradicts established knowledge, 3=uncertain/speculative, 5=well-grounded\\[2pt]
Novelty (1--5): Does the claim add genuinely new information?\\
\quad 1=trivially obvious/redundant, 3=moderately novel, 5=genuinely surprising\\[2pt]
Falsifiability (1--5): Is the falsification condition concrete and testable?\\
\quad 1=unfalsifiable/vague, 3=partially testable, 5=precisely operationalised\\[2pt]
Clarity (1--5): Is the claim stated clearly and specifically?\\
\quad 1=vague/ambiguous, 3=partially clear, 5=precise and unambiguous\\[4pt]

Respond with ONLY a valid JSON object:\\
\{``plausibility'': N, ``novelty'': N, ``falsifiability'': N, ``clarity'': N\}
\end{quote}
