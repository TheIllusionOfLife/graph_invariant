...
\multirow{4}{*}{\shortstack[l]{Wikidata\\Materials}}
  ...
  & Frequency       & $0.39 \pm 0.03$ & --- \\
  & DistMult-alone  & $0.32 \pm 0.05$ & $0.11 \pm 0.02$ \\
  & Harmony (ours)  & $\textbf{0.34} \pm 0.04$ & $\textbf{0.12} \pm 0.01$ \\
\bottomrule
\end{tabular}
\end{table}
...
frequency heuristic proves a strong competitor on Hits@10 across all domains,
particularly on denser KGs where edge-type distributions are more informative.
